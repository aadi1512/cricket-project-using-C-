...
void Game ::welcome()
{
	cout << "\t|-------------------------------------|\n"
		 ...
		 << "\t|------------------------------------------|\n"
		 << "\t|                                          |\n"
		 << "\t| 1. Create two teams with 4 player each.  |\n"
		 << "\t| 2. Lead the toss and decide the play.    |\n"
...
{
    cout << "Team-A " << teamA.totalRunsScored << " - "
		 << teamA.wicketsLost << " (" << teamB.totalBallsBowled << ")" << endl;
    ...
    cout << "=========================================" << endl
         << endl;
    cout << "Team-B " << teamB.totalRunsScored << " - "
		 << teamB.wicketsLost << " (" << teamA.totalBallsBowled << ")" << endl;
    ...
    for (int i = 0; i < playersPerTeam; i++)
    {
        cout << "|"
             ...
             << teamBPlayers[i].ballsBowled << "-" << teamBPlayers[i].runsGiven << "-" << teamBPlayers[i].wicketsTaken << "\t|"
             << endl;
    }
    cout << "=========================================" << endl
         << endl;
